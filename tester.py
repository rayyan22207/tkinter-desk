...
from sender_receiver import Communication
from storage import get_token
from urls import *
from commin import ACCESSTOKEN
print(get_token(ACCESSTOKEN))
test = Communication(AUTH_TOKEN=get_token(ACCESSTOKEN))
test.login_user(username='rayyan', password='idkidkidk')
# print(test.get(endpoint=get_meeps_url()))
